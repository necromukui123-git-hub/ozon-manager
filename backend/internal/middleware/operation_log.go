...
func parseOperationType(path, method string) string {
	operationMap := map[string]string{
		...
		"PUT /api/v1/promotions/search-cpo/config":            "search_cpo_config",
		"POST /api/v1/promotions/search-cpo/products/refresh": "search_cpo_refresh",
		"POST /api/v1/promotions/search-cpo/runs":             "search_cpo_run",
		"POST /api/v1/promotions/search-cpo/automation/run":   "search_cpo_automation_run",
